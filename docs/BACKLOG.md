...
| FEAT-16 | Open the machine's own terminal with `KUBECONFIG` and the context pointed at this cluster; explicit state when `kubectl` is missing | P1 | S | in-progress | 0 |
